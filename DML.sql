...
INSERT INTO sucursal(id_sucursal,dirección,ciudad,codigo_postal,cod_entidad)
VALUES
('0001','PLAÇA OCTAVIA, 6,','SANT CUGAT DEL VALLES','08172','0081'),
('0108','PASEO DE LA EXPLANADA, 2 ENTLO.IZQDA.','ALICANTE','03002','1544'),
('3059','MELQUIADES ALVAREZ, 7','OVIEDO (ASTURIAS)','33002','3059'),
('0182','PZA.DE SAN NICOLAS, 4','BILBAO (VIZCAYA)','48005','0182'),
('0050','RIBERA DEL LOIRA, 28 2ª PLTA.','COMUNIDAD DE MADRID, ES-MA','28000','0149'),
('0002','PICO DE SAN PEDRO, 2 APDO.14261','TRES CANTOS (MADRID)','28760','0128'),
('2100','MALLORCA, 165','BARCELONA (BARCELONA)','08036','3029'),
('3045','PASSATGE DEL LLAURADOR, 1','ALTEA (ALICANTE)','03590','3045'),
('9000','ALCALA, 50','MADRID (MADRID)','28014','9000'),
('3190','BERNA, 1','TOLEDO (TOLEDO)','45003','3190');
